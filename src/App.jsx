...
import { Building2, Wallet, BarChart3, Smartphone, Bell, CheckCircle, ArrowRight, Menu, X, Users, Home, TrendingUp, Star, Zap, Clock, Shield } from 'lucide-react';
...
export default function DormEaseLanding() {
  ...
  const features = [
    {
      ...
      description: "Track occupancy in real-time, assign rooms effortlessly, and manage complete tenant profiles with document storage."
    },
    {
      icon: <Wallet className="w-7 h-7" />,
      title: "Automated Billing & Payments",
      description: "Generate monthly invoices automatically, track payment status, and send reminders without lifting a finger."
    },
    {
      icon: <BarChart3 className="w-7 h-7" />,
      title: "Real-Time Analytics",
      description: "Monitor income, expenses, and occupancy rates with beautiful dashboards that update instantly."
    },
    {
      icon: <Smartphone className="w-7 h-7" />,
      title: "Mobile Access",
      description: "Manage your dormitory from anywhere. Both admins and tenants get full mobile access on any device."
    },
    {
      icon: <Bell className="w-7 h-7" />,
      title: "Smart Notifications",
      description: "Automated rent reminders, maintenance updates, and announcements keep everyone informed."
    },
    {
      icon: <CheckCircle className="w-7 h-7" />,
      title: "Maintenance Tracking",
      description: "Log requests, track resolution status, and maintain a complete history of all maintenance activities."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 text-white overflow-x-hidden">
      ...
      {/* Navigation */}
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-slate-950/90 backdrop-blur-xl border-b border-white/10 shadow-2xl' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <span className="text-xl sm:text-2xl font-bold gradient-text">DormEase</span>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
              ...
              <button onClick={() => scrollToSection('how-it-works')} className="text-slate-300 hover:text-white transition-colors font-medium">How It Works</button>
              <button onClick={() => scrollToSection('testimonials')} className="text-slate-300 hover:text-white transition-colors font-medium">Testimonials</button>
              <button onClick={() => scrollToSection('pricing')} className="text-slate-300 hover:text-white transition-colors font-medium">Pricing</button>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden pt-4 pb-4 space-y-3 animate-slide-in">
              <button onClick={() => scrollToSection('features')} className="block w-full text-left px-4 py-2 text-slate-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors font-medium">Features</button>
              <button onClick={() => scrollToSection('how-it-works')} className="block w-full text-left px-4 py-2 text-slate-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors font-medium">How It Works</button>
              <button onClick={() => scrollToSection('testimonials')} className="block w-full text-left px-4 py-2 text-slate-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors font-medium">Testimonials</button>
              <button onClick={() => scrollToSection('pricing')} className="block w-full text-left px-4 py-2 text-slate-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors font-medium">Pricing</button>
      ...
      {/* Hero Section */}
      <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-24 px-4 sm:px-6 noise-bg overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className={`space-y-6 sm:space-y-8 text-center lg:text-left ${mounted ? 'opacity-100' : 'opacity-0'} transition-opacity duration-1000`}>
              ...
              <p className="text-lg sm:text-xl text-slate-300 leading-relaxed animate-slide-in delay-200 max-w-2xl mx-auto lg:mx-0">
                Manage tenants, payments, maintenance requests, and reports — all in one powerful platform. Say goodbye to Excel spreadsheets and paperwork chaos.
              </p>
              ...
              <div className="grid grid-cols-3 gap-4 sm:gap-6 lg:gap-8 pt-6 animate-slide-in delay-400">
                <div className="text-center lg:text-left group">
                  <div className="text-2xl sm:text-3xl font-bold gradient-text group-hover:scale-110 transition-transform">2,000+</div>
                  <div className="text-xs sm:text-sm text-slate-400 mt-1">Rooms Managed</div>
                </div>
                <div className="text-center lg:text-left border-x border-slate-700/50 px-2 group">
                  <div className="text-2xl sm:text-3xl font-bold gradient-text group-hover:scale-110 transition-transform">99.8%</div>
                  <div className="text-xs sm:text-sm text-slate-400 mt-1">System Uptime</div>
                </div>
                <div className="text-center lg:text-left group">
                  <div className="text-2xl sm:text-3xl font-bold gradient-text group-hover:scale-110 transition-transform">₱5M+</div>
                  <div className="text-xs sm:text-sm text-slate-400 mt-1">Monthly Collection</div>
                </div>
              </div>
            </div>
              ...
              <div className="relative glow-box rounded-2xl sm:rounded-3xl p-6 sm:p-8 space-y-4 sm:space-y-6 animate-float">
                ...
                <div className="flex items-center justify-between pb-4 border-b border-white/10">
                  <div>
                    ...
                    <div className="text-2xl sm:text-3xl font-bold gradient-text">₱324,500</div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 sm:p-4 bg-slate-800/50 rounded-xl border border-white/5 hover:border-violet-500/30 hover:bg-slate-800/70 transition-all duration-300 group">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-semibold text-sm sm:text-base">Occupancy Rate</div>
                        <div className="text-xs sm:text-sm text-slate-400">42/45 rooms</div>
                      </div>
                    </div>
                    <div className="flex flex-col items-end">
                      <div className="text-xl sm:text-2xl font-bold text-green-400">93%</div>
                  ...
                  <div className="flex items-center justify-between p-3 sm:p-4 bg-slate-800/50 rounded-xl border border-white/5 hover:border-pink-500/30 hover:bg-slate-800/70 transition-all duration-300 group">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-semibold text-sm sm:text-base">Payments Collected</div>
                        <div className="text-xs sm:text-sm text-slate-400">This month</div>
                      </div>
                    </div>
                    <div className="flex flex-col items-end">
                      <div className="text-xl sm:text-2xl font-bold text-pink-400">38/42</div>
                  ...
                  <div className="flex items-center justify-between p-3 sm:p-4 bg-slate-800/50 rounded-xl border border-white/5 hover:border-orange-500/30 hover:bg-slate-800/70 transition-all duration-300 group">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="font-semibold text-sm sm:text-base">Pending Requests</div>
                        <div className="text-xs sm:text-sm text-slate-400">Maintenance</div>
                      </div>
                    </div>
                    <div className="flex flex-col items-end">
      ...
      <section className="relative py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-b from-transparent to-slate-950/50">
        <div className="max-w-5xl mx-auto text-center space-y-6 sm:space-y-8">
          ...
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 pt-6 sm:pt-8">
            {[
              { icon: "📊", text: "Manual tracking of payments is time-consuming and error-prone" },
              { icon: "🏠", text: "Hard to monitor available rooms and occupancy rates" },
              { icon: "⏰", text: "Tenants forget rent due dates, causing delayed payments" },
              { icon: "📈", text: "No clear financial reports to track your business growth" }
            ].map((problem, index) => (
              <div key={index} className="glow-box rounded-xl sm:rounded-2xl p-5 sm:p-6 text-left" style={{ animationDelay: `${index * 0.1}s` }}>
                <div className="text-3xl sm:text-4xl mb-3">{problem.icon}</div>
                <p className="text-slate-300 text-base sm:text-lg">{problem.text}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 space-y-4">
            ...
            <p className="text-lg sm:text-xl text-slate-400 max-w-2xl mx-auto px-4">
              Powerful features designed specifically for dormitory management in the Philippines
            </p>
          </div>
      ...
      {/* How It Works */}
      <section id="how-it-works" className="relative py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-b from-slate-950/50 to-transparent">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 space-y-4">
            ...
            <p className="text-lg sm:text-xl text-slate-400 px-4">No technical expertise required</p>
          </div>
            ...
            {[
              {
                ...
                description: "Create your account and add your dormitory details in minutes. No credit card required for the trial."
              },
              {
                step: "02",
                title: "Add Rooms and Tenants",
                description: "Set up your rooms, define pricing, and invite tenants to the platform. Bulk import available for existing data."
              },
              {
                step: "03",
                title: "Start Managing Operations",
                description: "Track payments, handle maintenance requests, and access real-time reports. Everything in one dashboard."
              }
            ].map((step, index) => (
              <div key={index} className="glow-box rounded-xl sm:rounded-2xl p-6 sm:p-8 flex flex-col sm:flex-row gap-6 items-start sm:items-center">
                <div className="text-5xl sm:text-6xl md:text-7xl font-bold gradient-text flex-shrink-0">{step.step}</div>
                <div>
                  <h3 className="text-xl sm:text-2xl font-bold mb-2">{step.title}</h3>
                  <p className="text-slate-400 text-base sm:text-lg">{step.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="testimonials" className="relative py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 space-y-4">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold px-4">
              Loved by{' '}
              <span className="gradient-text">Dorm Owners</span>
            </h2>
            <p className="text-lg sm:text-xl text-slate-400 px-4">See what our users are saying</p>
          </div>
          ...
          <div className="relative">
            <div className="glow-box rounded-2xl sm:rounded-3xl p-8 sm:p-12 text-center space-y-6">
              ...
              <div>
                <div className="font-bold text-lg sm:text-xl">{testimonials[activeTestimonial].name}</div>
                <div className="text-slate-400 text-sm sm:text-base">{testimonials[activeTestimonial].role}</div>
              </div>
      ...
      {/* Pricing Section */}
      <section id="pricing" className="relative py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-b from-transparent to-slate-950/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 sm:mb-16 space-y-4">
            ...
            <p className="text-lg sm:text-xl text-slate-400 px-4">Choose the plan that fits your dormitory size</p>
          </div>
            ...
            {[
              {
                ...
                features: ["Up to 20 rooms", "Unlimited tenants", "Payment tracking", "Basic reports", "Email support"]
              },
              {
                name: "Pro",
                price: "₱2,499",
                ...
                features: ["Up to 50 rooms", "Unlimited tenants", "Advanced analytics", "Automated billing", "Priority support", "Mobile app access"],
                popular: true
              },
              {
                name: "Enterprise",
                ...
                features: ["Unlimited rooms", "Multiple properties", "Custom integrations", "Dedicated account manager", "24/7 support", "Custom training"]
              }
            ].map((plan, index) => (
              <div
                key={index}
      ...
      <section className="relative py-16 sm:py-24 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
          ...
          <p className="text-lg sm:text-xl text-slate-300 px-4">
            Join 150+ successful dorm owners who've transformed their management process
          </p>
